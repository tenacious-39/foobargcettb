...
function DashboardBodyRight({ user, setUser }) {
    ...
    function handleSubmit(event) {
        ...
        axios
            .post('https://foobargcettb.vercel.app/updateHandles', newUserHandle)
    ...
    function handleLogIn() {
        // var uri = process.env.REACT_APP_LOGIN_URL;
        window.open("https://foobargcettb.vercel.app/auth/google", "_self");
    }
    function handleLogout() {
        window.open("https://foobargcettb.vercel.app/logout", "_self");
        setUser(null);
    }
    //console.log(user);
    if (!user) {
